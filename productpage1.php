...
if (!empty($_POST['disableAd'])) {
	disableAd($_POST['adId']);
...
<form name=""product" method="post">
		<div class="product-desc">
			...
			<input type="hidden" name="adId" value="<?php echo $adDetails[0]['AdID']; ?>"
				   <?php if (isUserLoggedIn() && ($adDetails[0]['AdId'] == $loggedInUser->user_id || UserRoles::ADMIN == $loggedInUser->role->value)) {
					   echo "<div class=\"signin\"> <input type=\"submit\" name=\"disableAd\" value=\"Disable Ad\"> </div>";
				   }?>
				</div>
			</div>
