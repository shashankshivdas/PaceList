	...
	$(document).ready(function() {
		...
		$('#proTitleDec_searchBtn').click(function(){
			...
			$.ajax({
				...
				dataType:"json",
				data: {"cat_id": <?php echo $cat_id; ?> ,"searh_term":$('#proTitleDec_search').val()},
				timeout:600000
			}).done(function(data)
			{            
				if(data.size > 0){	
		...
		$('#proTitleDec_searchBtn1').click(function(){
			...
			$.ajax({
				type: "POST",
				url:"searchTtl-ajax.php",
				dataType:"json",
				data: {"cat_id": <?php echo $cat_id; ?> ,"searh_term":$('#proTitleDec_search1').val()},
				timeout:600000
			}).done(function(data)
			{            
				if(data.size > 0){	
